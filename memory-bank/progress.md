...
- **Offboarding Definitivo de Técnicos (2026-09-10, DESPLEGADO 9e462f2):**
  ...
  - Deploy: migración aplicada en Supabase prod vía SQL Editor (columna `clients.notes` verificada en vivo), frontend en Vercel (commit 9e462f2, bundle verificado).
  - Restante no bloqueante: matriz RLS T12–T15 (falta anon key).
